...
scaleVelocity :: Weight -> Vector Weight -> Vector Weight
scaleVelocity factor = map (factor *)
...
sumVelocities :: NonEmpty (Vector Weight) -> Vector Weight
sumVelocities = foldl1' (.+)
